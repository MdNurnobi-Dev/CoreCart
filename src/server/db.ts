  ...
  private async initTursoSchema(): Promise<void> {
    ...
    const schemaStatements = [
      ...
      `CREATE TABLE IF NOT EXISTS chat_settings (
        ...
        telegram_bot_token TEXT DEFAULT '8921887336:AAHFQg1uwLIHcyIp1ofAcqY7qMFeKaISCQQ',
        telegram_chat_id TEXT DEFAULT '-1004430526389',
        telegram_bot_username TEXT DEFAULT 'TechShop_Live_Support_bot',
  ...
  private async initPostgresSchema(): Promise<void> {
    ...
    await this.pgPool.query(`
      ...
      CREATE TABLE IF NOT EXISTS chat_settings (
        ...
        auto_reply_message TEXT DEFAULT 'Thank you for reaching out! Our team has received your message and will respond shortly.',
        history_retention_days INTEGER DEFAULT 30,
        telegram_bot_token VARCHAR(255) DEFAULT '8921887336:AAHFQg1uwLIHcyIp1ofAcqY7qMFeKaISCQQ',
        telegram_chat_id VARCHAR(255) DEFAULT '-1004430526389',
        telegram_bot_username VARCHAR(255) DEFAULT 'TechShop_Live_Support_bot',
