# Version Control & Release Workflow (VERSIONING.md)
...
- **Feature Branches (`feature/<feature-name>`)**:
  ...
  - Merged into: `develop`
  - Example: `feature/predictive-search`, `feature/sslcommerz-gateway`
...
3. **Commit & Tag**:
   ...
   git tag -a v1.3.0 -m "Release version 1.3.0: Predictive Search and UI Polish"
...
### Examples:
- `feat(search): implement predictive search dropdown with quick-view`
- `fix(grid): balance product grid row items to 6-column symmetry`
- `docs(readme): add installation guide and deployment instructions`
